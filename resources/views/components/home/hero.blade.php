    ...
    <div class="flex flex-wrap -mx-4">
        ...
        <div class="hero-content">
          ...
          <p class="text-base mb-8 max-w-[520px]">
            ...
            <a
              ...
              href="https://www.youtube.com/@hassanhafiz44" target="_blank">YouTube Channel</a>. <br>
          </p>
      ...
      <div class="w-full lg:w-6/12 px-4">
        <div class="lg:text-right lg:ml-auto">
          <div class="relative inline-block z-10 mr-5 pt-11 lg:pt-0">
            <img
              src="{{ url('/img/hassan2.jpeg') }}"
              alt="hero"
